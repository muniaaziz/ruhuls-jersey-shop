...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-jersey-navy text-white pt-10 pb-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4 mt-4">
              <a href="#" className="text-white hover:text-jersey-purple transition-colors" aria-label="Facebook">
                <Facebook size={20} />
              </a>
              <a href="#" className="text-white hover:text-jersey-purple transition-colors" aria-label="Instagram">
                <Instagram size={20} />
              </a>
              <a href="#" className="text-white hover:text-jersey-purple transition-colors" aria-label="Twitter">
                <Twitter size={20} />
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                ...
                <a href="tel:+8801710093471" className="text-gray-300 hover:text-white transition-colors">+880 1710 093 471</a>
              </li>
              <li className="flex items-center">
                <Mail className="mr-2 flex-shrink-0" size={18} />
                <a href="mailto:info@ruhulsjersey.com" className="text-gray-300 hover:text-white transition-colors overflow-hidden text-ellipsis">{isMobile ? 'Email Us' : 'info@ruhulsjersey.com'}</a>
              </li>
              <li className="mt-4">
                <a 
                  href="https://wa.me/8801710093471" 
                  className="bg-green-600 text-white py-2 px-4 rounded-md flex items-center justify-center gap-2 hover:bg-green-700 transition-colors"
